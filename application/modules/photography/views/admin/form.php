		...
		$clickedItem.click(function() {
			$("#confirm").dialog({
				...
				buttons: {
					"OK": function() {		
						$( this ).dialog( "close" );
						$.post("<?php echo base_url(); ?>delete_photography_image/", {id: $clickedItem.attr("rel"), item_id: '<?php echo $this->uri->segment(4); ?>', position: $clickedItem.attr("rev"), <?php echo $this->config->item('csrf_token_name'); ?>: $('input[name="ci_token"]').val()});
...
<?php echo form_open_multipart(''); ?>
	...
	<div class="box radius5 border">
		<div class="header gradient2">
			<p><?php echo $this->uri->segment(3) == 'create' ? $this->lang->line('add_photography') : $this->lang->line('edit_photography'); ?></p>
		</div>
		<div class="content">
			<p>
		...
		<div class="content" id="images-panel" style="display:block;">	
			<div id="sort-images">
				...
				<div class="image" id="item_<?php echo $image->id; ?>">
					...
					<a href="<?php echo base_url(); ?>uploads/photography/<?php echo $image->name;?>" rel="lightbox"><img src="<?php echo image('uploads/photography/', $image->name, 140, 140); ?>" alt="" width="140" height="140"></a>	
