...
class Photography extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->load->model('photographymodel');
	...
	{			
		...
		$photography_per_page = $this->config->item('photography_per_page');
		...
		$paginator['total_rows'] = $this->photographymodel->count_photography();
		...
		$query = $this->photographymodel->get_all_photography($paginator['per_page'], $this->uri->segment(2));
	...
	{
		$this->load->helper('image');
		$page = $this->photographymodel->get_photography();
		$lang = $this->config->item('language_abbr');
                
                $images = $this->photographymodel->get_images();
