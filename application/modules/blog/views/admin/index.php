<div class="box radius5 border">
	<div class="header gradient2">
		<p><?php echo $this->lang->line('blog'); ?></p>
	</div>
		...
		<table style="width:100%" class="list sortable">
			...
			<tbody>	
				...
				<tr>
					...
					<td><a href="<?php echo base_url(); ?>admin/blog/edit/<?php echo $row->id;?>" class="edit"></a> <a href="<?php echo base_url(); ?>admin/blog/delete/<?php echo $row->id?>" class="delete" id="del_<?php echo $row->id;?>"></a></td>
				</tr>
				<?php endforeach; ?>
			</tbody> 
		</table>
