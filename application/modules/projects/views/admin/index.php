		...
		<table style="width:100%" class="list sortable">
			...
			<tbody>	
				...
				<tr>
					...
					<td><a href="<?php echo base_url(); ?>admin/projects/edit/<?php echo $row->id;?>" class="edit"></a> <a href="<?php echo base_url(); ?>admin/projects/delete/<?php echo $row->id?>" class="delete" id="del_<?php echo $row->id;?>"></a></td>
				</tr>
				<?php endforeach; ?>
			</tbody> 
		</table>
